import{r as o,d as i}from"./utilities-bdfaa4f6.js";function s(t){const e=`<p class='text-xl text-bold my-4' >${new Date(t.dateOrder).toLocaleDateString("pt-BR",{hour:"2-digit",minute:"2-digit"})}</p>
